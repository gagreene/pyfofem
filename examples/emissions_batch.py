...
_EXAMPLE_DATA_DIR = os.path.join(_PROJECT_ROOT, 'examples', 'example_data')
...
def main():
    ...
    csv_path = os.path.join(
        _EXAMPLE_DATA_DIR, 'fofem_emissions_batch_test.csv'
    )
    ...
    # Save results
    # ------------------------------------------------------------------
    out_dir = os.path.join(_EXAMPLE_DATA_DIR, '_results')
