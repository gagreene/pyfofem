...
# -*- coding: utf-8 -*-
"""
test_emissions_parity.py - Phase 4 coverage for
...
#: centralized policy rather than a literal - ``consume_expanded_matrix.emissions_legacy``
#: and ``consume_expanded_matrix.emissions_expanded`` record the same 5e-07. The measured
...
RTOL_EMISSION = expanded_matrix_tolerance("consume", "emissions_legacy")[1]
