...
# -*- coding: utf-8 -*-
"""
test_generate_canonical_goldens.py - Driver tests for the canonical (Phase 2) golden
generator/promoter (``generate_canonical_goldens.py``), per the plan's
...
import tests.cpp_parity_live.generate_canonical_goldens as gpg
